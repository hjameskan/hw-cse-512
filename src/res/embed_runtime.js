...
function $(e, t, n) {
    ...
    return r.className = "observablehq--field", o.className = n, o.textContent = `  ${e}`, r.appendChild(document.createTextNode(": ")), r.appendChild(ae(t)), r
}

function S(e, t) {
    const n = document.createElement("div");
    return n.className = "observablehq--field", n.appendChild(document.createTextNode("  ")), n.appendChild(ae(e)), n.appendChild(document.createTextNode(" => ")), n.appendChild(ae(t)), n
}
...
function L(e, n, o, a) {
    ...
    if (e instanceof Map ? e instanceof e.constructor ? (i = `Map(${e.size})`, s = k) : (i = "Map()", s = U) : e instanceof Set ? e instanceof e.constructor ? (i = `Set(${e.size})`, s = M) : (i = "Set()", s = U) : u ? (i = `${e.constructor.name}(${e.length})`, s = R) : (l = h(e)) ? (i = `Immutable.${l.name}${"Record"===l.name?"":`(${e.size})`}`, u = l.arrayish, s = l.arrayish ? P : l.setish ? I : D) : (i = d(e), s = U), n) {
        const t = document.createElement("span");
        return t.className = "observablehq--shallow", o && t.appendChild(r(o)), t.appendChild(document.createTextNode(i)), t.addEventListener("mouseup", (function(n) {
...
function B(e, t, n) {
    const r = document.createDocumentFragment(),
        o = r.appendChild(document.createElement("span"));
    return o.className = n, o.textContent = e, r.appendChild(document.createTextNode(": ")), r.appendChild(ae(t, !0)), r
}
...
function re(e, t, n) {
    ...
    return a.className = "observablehq--keyword", a.textContent = e.prefix, o.appendChild(document.createTextNode(t)), o
}
const {
    prototype: {
        toString: oe
    ...
    switch (s) {
        ...
        case "string":
            return function(e, t, n, o) {
                ...
                return i.className = "observablehq--string", i.textContent = JSON.stringify(e.length > 100 ? `${e.slice(0,50)}…${e.slice(-49)}` : e), a
            }(e, t, n, o);
        default:
            if (null === e) {
                s = null, e = "null";
...
class Inspector {
    ...
    fulfilled(t, n) {
        ...
        if ((! function(e) {
            ...
            }(t) || t.parentNode && t.parentNode !== r) && (t = ae(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"), r.classList.remove("observablehq--running", "observablehq--error"), r.firstChild !== t)
            if (r.firstChild) {
    ...
    rejected(t, n) {
        ...
        a.className = "observablehq--inspect", n && a.appendChild(r(n)), a.appendChild(document.createTextNode((t + "").replace(se, ""))), o.appendChild(a), e(o, "error", {
            error: t
        })
    }
}
...
function pe(e) {
    var t, n = e.getUTCHours(),
        ...
        o = e.getUTCSeconds(),
        a = e.getUTCMilliseconds();
    return isNaN(e) ? "Invalid Date" : ((t = e.getUTCFullYear()) < 0 ? "-" + de(-t, 6) : t > 9999 ? "+" + de(t, 6) : de(t, 4)) + "-" + de(e.getUTCMonth() + 1, 2) + "-" + de(e.getUTCDate(), 2) + (a ? "T" + de(n, 2) + ":" + de(r, 2) + ":" + de(o, 2) + "." + de(a, 3) + "Z" : o ? "T" + de(n, 2) + ":" + de(r, 2) + ":" + de(o, 2) + "Z" : r || n ? "T" + de(n, 2) + ":" + de(r, 2) + "Z" : "")
}
    ...
    function r(e, t) {
        ...
        function u() {
            ...
            if (34 === e.charCodeAt(o)) {
                ...
                return (t = i) >= a ? c = !0 : 10 === (r = e.charCodeAt(i++)) ? l = !0 : 13 === r && (l = !0, 10 === e.charCodeAt(i) && ++i), e.slice(o + 1, t - 1).replace(/""/g, '"')
            }
            for (; i < a;) {
...
function nt(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    return async function(r, o) {
        ...
        if (a.path && !et.test(a.path) && (a.path += ".js"), a.path && a.version && Qe.test(a.version)) return `${e}${a.name}@${a.version}/${a.path}`;
        const i = await n(a);
        return `${e}${i.name}@${i.version}/${a.path||function(e){for(const n of t){let t=e[n];if("string"==typeof t)return t.startsWith("./")&&(t=t.slice(2)),et.test(t)?t:`${t}.js`}}(i)||"index.js"}`
    }
}
...
function ct(e, t, n) {
    ...
    r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), Ye.push(Je.call(t, st) ? e => {
        ...
        return Promise.all(Ze.call(t, (t => "exports" === (t += "") ? r : "module" === t ? o : e(t)))).then((e => (n.apply(null, e), o.exports)))
    ...
    async query(e, t) {
        return await async function(e, t, n) {
            ...
            const {
                columns: o,
                values: a
            } = r, i = a.map((e => Object.fromEntries(e.map(((e, t) => [o[t], e])))));
    ...
    static async of(e = {}, t = {}) {
        const n = await async function() {
            ...
            const {
                ...
                bundle: t,
                logger: n
            } = await ut, r = await e.createWorker(t.mainWorker), o = new e.AsyncDuckDB(n, r);
        ...
        return void 0 === t.query?.castTimestampToDate && (t = {
            ...
            else if (vt(t)) await async function(e, t, n) {
    ...
    try {
        switch (n.mimeType) {
            ...
            default:
                ...
                if (/\.parquet$/i.test(n.name)) return await a.query(`CREATE VIEW '${t}' AS SELECT * FROM parquet_scan('${n.name}')`);
...
const It = Object.assign((async (e, t, n, r) => {
    if (e = await Rt(await e, r), (o = e) && ("function" == typeof o.sql || "function" == typeof o.queryTag && ("function" == typeof o.query || "function" == typeof o.queryStream)) && ("table" !== a || "function" == typeof o.describeColumns) && o !== It) return Ft(e, function(e, t) {
        ...
        const c = new Map(e.names?.map((({
            ...
            l = [
                [`SELECT ${r.columns?r.columns.map((e=>{const t=c.get(e);return t?`${n(e)} AS ${n(t)}`:n(e)})).join(", "):"*"} FROM ${Bt(o.table,n)}`]
            ];
    ...
    if (jt(e)) return function(e, t) {
        ...
        let {
            ...
            if (!$t(n)) return n = dn(e, St(t) ? t : void 0), {
                schema: n,
                inferred: !0
            };
            return {
        ...
        if (t.select.columns) {
            ...
            r && (r = t.select.columns), e = e.map((e => Object.fromEntries(t.select.columns.map((t => [t, e[t]])))))
        }
        if (t.names) {
            ...
            }))), r && (r = r.map((e => n.get(e)?.name ?? e))), e = e.map((e => Object.fromEntries(Object.keys(e).map((t => [n.get(t)?.name ?? t, e[t]])))))
        }
...
function Pt(e) {
    ...
    return (n, r) => {
        ...
        let o = t.get(n);
        return (!o || jt(n) && n.length !== o._numRows) && (o = e(n, r), o._numRows = n.length, t.set(n, o)), o
    }
}
const Rt = Pt((async (e, t) => {
        ...
        return _t(e) || vt(e) ? Dt(e, t) : jt(e) && Ot(e) ? Array.from(e, (e => ({
            value: e
        }))) : e
    })),
    Ut = Pt((async (e, t) => {
...
function dn(e, t = function(e) {
    ...
    for (const e of t) {
        ...
        for (const n of r) {
            ...
            if (null == r) continue;
            const o = typeof r;
            if ("string" !== o) ++t.defined, Array.isArray(r) ? ++t.array : r instanceof Date ? ++t.date : r instanceof ArrayBuffer ? ++t.buffer : "number" === o ? (++t.number, Number.isInteger(r) && ++t.integer) : o in t && ++t[o];
            else {
        ...
        const o = Math.max(1, .9 * t.defined),
...
function pn(e) {
    ...
    if (t && "object" == typeof t && !(t instanceof Date)) {
        ...
        if (t.text) {
            ...
            return e.richText && (e = mn(e)), t.hyperlink && t.hyperlink !== e ? `${t.hyperlink} ${e}` : e
        }
        return t
    }
    return t
...
async function yn(e, t, {
    ...
    if ("auto" === r && !n) {
        ...
        return function(e, t) {
            ...
            return Object.assign(e.map((e => un(e, n, t))), {
                schema: t
            })
        }(e, dn(e, e.columns))
    }
...
var xn = Object.freeze({
    ...
    element: function(e, t) {
        ...
        if (t)
            for (var i in t) o = (r = i).indexOf(":"), n = t[i], o >= 0 && "xmlns" !== (r = i.slice(0, o)) && (i = i.slice(o + 1)), gn.hasOwnProperty(r) ? a.setAttributeNS(gn[r], i, n) : a.setAttribute(i, n);
        return a
    },
    input: function(e) {
    ...
    return function(n) {
        ...
        for (s = 1, c = arguments.length; s < c; ++s) {
            if ((r = arguments[s]) instanceof Node) d[++m] = r, f += "\x3c!--o:" + m + "--\x3e";
                ...
                for (l = 0, u = r.length; l < u; ++l)(o = r[l]) instanceof Node ? (null === p && (d[++m] = p = document.createDocumentFragment(), f += "\x3c!--o:" + m + "--\x3e"), p.appendChild(o)) : (p = null, f += o);
                p = null
            } else f += r;
            f += n[s]
        }
        if (p = e(f), ++m > 0) {
            for (a = new Array(m), i = document.createTreeWalker(p, NodeFilter.SHOW_COMMENT, null, !1); i.nextNode();) o = i.currentNode, /^o:/.test(o.nodeValue) && (a[+o.nodeValue.slice(2)] = o);
...
function Pn(e, t) {
    var n;
    return (n = In.get(e = +e)) ? n.then((() => t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function(e, t) {
...
const Library = Object.assign(Object.defineProperties((function(e) {
    ...
    Object.defineProperties(this, (n = {
        ...
        md: () => function(e) {
            return e(Le.resolve()).then((function(t) {
                return On((function(n) {
                    ...
                    return o.length > 0 && e(je.resolve()).then((function(t) {
        ...
        svg: () => Dn,
        tex: () => function(e) {
            return Promise.all([e($e.resolve()), e.resolve($e.resolve("dist/katex.min.css")).then(Bn)]).then((function(e) {
                var t = e[0],
                    n = r();
        ...
        mermaid: () => async function(e) {
            ...
            return t.initialize({
                ...
                function() {
                    ...
                    return e.innerHTML = t.render(Cn().id, String.raw.apply(String, arguments)), e.removeChild(e.firstChild)
                }
        }(t),
        Plot: () => t(Te.resolve()),
        __query: () => It,
...
function Variable(e, t, n) {
    var r;
    n || (n = Zn), Object.defineProperties(this, {
        _observer: {
            value: n,
            writable: !0
        },
...
function tr(e, t, n) {
    ...
    if (this._inputs.forEach(Kn, this), t.forEach(Jn, this), this._inputs = t, this._definition = n, this._value = void 0, n === Yn ? o._variables.delete(this) : o._variables.add(this), e !== this._name || r.get(e) !== this) {
        let t, a;
        if (this._name)
            if (this._outputs.size) r.delete(this._name), a = this._module._resolve(this._name), a._outputs = this._outputs, this._outputs = new Set, a._outputs.forEach((function(e) {
            ...
            a._duplicates.delete(this), this._duplicate = void 0, 1 === a._duplicates.size && (a = a._duplicates.keys().next().value, t = r.get(this._name), a._outputs = t._outputs, t._outputs = new Set, a._outputs.forEach((function(e) {
                e._inputs[e._inputs.indexOf(t)] = a
            })), a._definition = a._duplicate, a._duplicate = void 0, o._dirty.add(t).add(a), o._updates.add(a), r.set(this._name, a))
        }
        if (this._outputs.size) throw new Error;
        e && ((a = r.get(e)) ? 3 === a._type ? (this._definition = er(e), this._duplicate = n, a._duplicates.add(this)) : 2 === a._type ? (this._outputs = a._outputs, a._outputs = new Set, this._outputs.forEach((function(e) {
            e._inputs[e._inputs.indexOf(a)] = this
        }), this), o._dirty.add(a).add(this), r.set(e, this)) : (a._duplicate = a._definition, this._duplicate = n, t = new Variable(3, this._module), t._name = e, t._definition = this._definition = a._definition = er(e), t._outputs = a._outputs, a._outputs = new Set, t._outputs.forEach((function(e) {
            e._inputs[e._inputs.indexOf(a)] = t
        })), t._duplicates = new Set([this, a]), o._dirty.add(a).add(t), o._updates.add(a).add(t), r.set(e, t)) : r.set(e, this)), this._name = e
    }
...
Object.defineProperties(Variable.prototype, {
    ...
    define: {
        value: function(e, t, n) {
            ...
            return tr.call(this, null == e ? null : String(e), null == t ? [] : Gn.call(t, this._module._resolve, this._module), "function" == typeof n ? n : Hn(n))
        },
        writable: !0,
        configurable: !0
    },
...
Object.defineProperties(Module.prototype, {
    _resolve: {
        value: function(e) {
            ...
            if (!n)
                if (n = new Variable(2, this), this._builtins.has(e)) n.define(e, Hn(this._builtins.get(e)));
...
const sr = "function" == typeof requestAnimationFrame ? requestAnimationFrame : "function" == typeof setImmediate ? setImmediate : e => setTimeout(e, 0);
...
function pr(e, t) {
    let n, r, o = "function" == typeof IntersectionObserver && t._observer && t._observer._node,
        ...
        i = Yn,
        s = Yn;
    return o && (r = new IntersectionObserver((([e]) => (a = e.isIntersecting) && (n = null, i()))), r.observe(o), e.then((() => (r.disconnect(), r = null, s())))),
        function(e) {
            return a ? Promise.resolve(e) : r ? (n || (n = new Promise(((e, t) => (i = e, s = t)))), n.then((() => e))) : Promise.reject()
        }
}
...
function mr(e) {
    ...
    const t = e._value,
        n = ++e._version;
    let r = null;
    const o = e._promise = (e._inputs.length ? Promise.all(e._inputs.map(fr)).then((function(o) {
        if (e._version !== n) throw Qn;
        for (let t = 0, n = o.length; t < n; ++t) switch (o[t]) {
            case rr:
                o[t] = r = dr(e);
                break;
            case or:
        ...
        if (function(e) {
            ...
            }(t)) return (r || dr(e)).then((o = t, function() {
                o.return()
            })),
            function(e, t, n) {
...
function hr(e, t) {
    e._invalidate(), e._invalidate = Yn, e._pending(), ++e._version, e._indegree = NaN, (e._promise = Promise.reject(t)).catch(Yn), e._value = void 0, e._rejected(t)
}
        ...
        value: async function() {
            ...
            do {
                for (e.forEach((function(e) {
                    ...
                    })); t = n.pop();) mr(t), t._outputs.forEach(o), e.delete(t);
                e.forEach((function(t) {
                    cr(t) && (hr(t, new RuntimeError("circular definition")), t._outputs.forEach(ur), e.delete(t))
                }))
            } while (e.size);
